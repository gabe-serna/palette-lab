      ...
      <div className="relative flex flex-col w-1/2">
        <h1 className="z-20 text-7xl">
          ...
          <div className="relative z-10 inline">
            Colors{" "}
            <div className="absolute -top-8 -left-12 size-[200%] bg-[radial-gradient(closest-corner_at_40%_50%,_hsla(from_hsl(var(--tertiary))_h_s_calc(l_*_0.75)_/_0.35)_0%,_rgba(36,_36,_36,_0)_50%)] rotate-12 -z-10" />
          </div>
          into
          <br />
          the{" "}
