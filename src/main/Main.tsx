const Main = () => {
  return (
    <>
      <div className="flex flex-col items-center justify-center size-full bg-gradient-to-b from-[hsl(from_hsl(var(--primary))_h_calc(s_*_0.75)_calc(l_*_.4))] to-[hsl(var(--background))] to-5%">
